...
const columns: Column[] = [
  ...
  { id: "from", label: "Customers", minWidth: 160, align: "left" }, // New column
  { id: "status", label: "status", minWidth: 100, align: "left" },
  { id: "action", label: "Action", minWidth: 100, align: "center" }, // New Action column
];

const initialRows: Data[] = [
  { invoice: 3, customer: "item 1", total: 2500, units: "1kg", quantity: 25, saleprice: 100, paymentStatus: "Paid", date: "2023-10-01", from: "Company A" },
  { invoice: 2, customer: "item 2", total: 1250, units: "500g", quantity: 25, saleprice: 50, paymentStatus: "Overdue", date: "2023-10-02", from: "Company B" },
  { invoice: 1, customer: "item 3", total: 625, units: "250g", quantity: 25, saleprice: 25, paymentStatus: "Pending", date: "2023-10-03", from: "Company C" },
];
    ...
    if (editRow) {
      ...
      const updatedRows = rows.map((row) =>
        row.invoice === editRow.invoice
          ? { ...row, customer, total, units, quantity, saleprice, paymentStatus, date, from }
          : row
      );
      setRows(updatedRows);
    } else {
            ...
            <TableHead>
              <TableRow>
                <TableCell colSpan={isSmallScreen ? 2 : 3} align="center">
                  <Typography variant={isSmallScreen ? "h5" : "h3"}>Product Out</Typography>
                </TableCell>
                <TableCell colSpan={isSmallScreen ? 2 : 3} align="center">
